<%-- 
    ...
    Created on : May 31, 2022, 12:02:24 AM
    Author     : DUC THINH
--%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <form action="saledashboard" method="post" style="display: flex ">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Earnings </div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><fmt:formatNumber pattern="###,###,###" value="${sumTotal}" /> VND</div>
                                            </div>
                                            <div class="col-auto">
