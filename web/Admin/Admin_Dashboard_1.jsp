    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="saledashboard">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">${accountName}</span>
                    ...
                    <div class="container-fluid">
                        ...
                        <form action="admindashboard" method="post" style="display: flex " id="filter">
                            <!--                            <div class="select-box" style="float: left; margin-right: 30px">
                                                            <label for="select-box1" class="label select-box1"><span class="label-desc">Choose a customer</span> </label>
                                                            <select name="accountID" class="select" onchange="document.getElementById('filter').submit();">
                                                                <option value="0">All Customer</option>
                            <c:forEach var="i" items="${listAccount}">
                                <c:if test="${accountID == i.accountID}">
                                    <option value="${i.accountID}" selected="">${i.name}</option>
                                </c:if>
                                <c:if test="${accountID != i.accountID}">
                                    <option value="${i.accountID}" >${i.name}</option>
                                </c:if>  
                            </c:forEach>
                        </select>
                            ...
                            <div style="float: right">
                               <!-- From
                                ...
                                <b>Year</b>
                                <select name="year">
                                    <c:forEach var="i" begin="2010" end="2026">
                                ...
                                <button class="btn"><a href="admindashboard">Reset</a></button>
                            </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <fmt:formatNumber pattern="###,###,###" value="${totalEarning}"/> VND 
                                                </div>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card shadow mb-4" style="padding-bottom: 130px">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-area" >
                                            <canvas id="myChart" width="1504px" height="300px"></canvas>
                                            <script>
